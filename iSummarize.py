...
st.subheader('Submission for the Orkes Hack')


image = Image.open('Summarize.jpg')
st.sidebar.image(image, use_column_width=True)
st.sidebar.markdown('<center> <h1>iSummarize</h1></center>',unsafe_allow_html=True)
...
st.sidebar.markdown('<h4>Made By:<br/><br/>Vishal Barman<br/>Team Virtual Rider</h4>',unsafe_allow_html=True)
